...
- **Memory Management** - Every process gets an illusion of logically contiguous, nearly unlimited memory irrespective of *physical memory* present in the system. The key idea here is paging based on LRU (Least Recently Used) policy
