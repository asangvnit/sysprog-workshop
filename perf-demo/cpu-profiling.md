...
[Linux profiling with performance counters](https://perfwiki.github.io/main/) explains how performance measurement can be done. It is done using `perf` command. To collect the profiles on per-process, per-thread, per-cpu basis. We need an illustrative program to do some measurements. [bottlencks.cpp](bottlenecks.cpp) is a simple program generated by [ChatGPT](https://chatgpt.com/) for this purpose. To compile the program
